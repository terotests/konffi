...
function _start_server() {
    ...
    app.get('/files', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, server_1.readFolder(process.cwd(), true)];
                case 1:
                    data = _a.sent();
                    res.json(data);
                    return [2 /*return*/];
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    _b = (_a = res).json;
                    return [4 /*yield*/, server_1.getProjects()];
                case 1:
                    _b.apply(_a, [_c.sent()]);
                    return [2 /*return*/];
            }
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    project = _c.sent();
                    _b = (_a = res).json;
                    return [4 /*yield*/, server_1.readDir(project, req.body.path, true)];
                case 2:
                    _b.apply(_a, [_c.sent()]);
                    return [2 /*return*/];
            }
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    project = _c.sent();
                    _b = (_a = res).json;
                    return [4 /*yield*/, server_1.readProjectFile(project, req.body.path)];
                case 2:
                    _b.apply(_a, [_c.sent()]);
                    return [2 /*return*/];
            }
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    project = _c.sent();
                    _b = (_a = res).json;
                    return [4 /*yield*/, server_1.saveProjectFile(project, req.body.path, req.body.content)];
                case 2:
                    _b.apply(_a, [_c.sent()]);
                    return [2 /*return*/];
            }
